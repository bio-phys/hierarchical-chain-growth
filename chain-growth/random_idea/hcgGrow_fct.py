...
#### modified functions for rhcg

def fragment_assembly_w(u1, u2, dire, select, index_clash_l, index_merge_l,
    ...
    for m , fragment_l in enumerate(hcg_l):
        ...
        for m_i , pair_l in enumerate(fragment_l):
            ...
            if  draw_indices:
                ...
                rs, acw_mi = fragment_assembly_w(u1, u2, dire, select, index_clash_l, index_merge_l,
                ...
                rs = r_l[m_i]
                acw_mi = fragment_assembly_w(u1, u2, dire, select, index_clash_l, index_merge_l,
